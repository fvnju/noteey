    ...
    <div className="min-h-screen bg-[#fafaf8] text-[#1a1a18] antialiased">
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center px-6 pt-20 text-center">
        ...
        >
          ...
          <h1 className="mb-8 text-6xl font-semibold leading-[1.08] tracking-tight sm:text-7xl md:text-8xl">
            Where ideas
            <br />
      ...
      <section id="cta" className="px-6 py-32">
        <div className="mx-auto max-w-3xl text-center">
          <RevealOnScroll>
            ...
            <h2 className="mb-8 text-4xl font-semibold tracking-tight sm:text-5xl md:text-6xl">
              Your thoughts
              <br />
              <span className="bg-gradient-to-r from-amber-500 via-amber-600 to-orange-500 bg-clip-text text-transparent">
                deserve a home.
